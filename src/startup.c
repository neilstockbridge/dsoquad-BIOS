...
#define  RESERVED_VECTOR  0x00000000

// See Page 27 of "Cortex-M3 programming manual" for the structure of this
// table
__attribute__ ((section(".isr_vectors")))
void (* const g_pfnVectors[])(void) = {
    // Common to all Cortex-M3:
    (intfunc)((unsigned long)&_estack), // The initial value for SP ( the stack pointer)
    Reset_Handler, NMIException, HardFaultException,
    MemManageException, BusFaultException, UsageFaultException, RESERVED_VECTOR, RESERVED_VECTOR,
    RESERVED_VECTOR, RESERVED_VECTOR, SVCHandler, DebugMonitor, RESERVED_VECTOR, PendSVC, SysTickHandler,
    // IRQ0..IRQ67, specific to SoC:
